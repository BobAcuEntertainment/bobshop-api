...
var (
	...
	InvalidEvent            = New(http.StatusBadRequest, "invalid_event")
	InvalidTimezone         = New(http.StatusBadRequest, "invalid_timezone")
	...
	ExchangeNotFound        = New(http.StatusNotFound, "exchange_not_found")
	TraderNotFound          = New(http.StatusNotFound, "trader_not_found")
	TraderDisabled          = New(http.StatusNotFound, "trader_disabled")
	TraderConflict          = New(http.StatusConflict, "trader_conflict")
	StrategyNotFound        = New(http.StatusNotFound, "strategy_not_found")
	StrategyDisabled        = New(http.StatusNotFound, "strategy_disabled")
	StrategyConflict        = New(http.StatusConflict, "strategy_conflict")
	ConfigNotFound          = New(http.StatusNotFound, "config_not_found")
	ConfigConflict          = New(http.StatusConflict, "config_conflict")
)
